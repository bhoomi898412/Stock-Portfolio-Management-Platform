...
function CreateTicket() {
    return ( 
        <div className="container">
            ...
            <div className="row mt-5">
                <div className="col-4">
                    <h1 className="fs-5 mb-3"><i class="fa fa-plus-circle p-2" aria-hidden="true"></i>Account Opening</h1>
                ...
                <div className="col-4">
                    <h1 className="fs-5 mb-3"><i class="fa fa-user-circle p-2" aria-hidden="true"></i>Your Zerodha Account</h1>
                ...
                <div className="col-4">
                    <h1 className="fs-5 mb-3"><i class="fa fa-bar-chart p-2" aria-hidden="true"></i>Your Zerodha Account</h1>
                    <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Margine/leverage, Product and Order types</a><br />
                    ...
                    <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Stpckreports+</a><br />
            ...
            <div className="row mt-5">
                <div className="col-4">
                    <h1 className="fs-5 mb-3"><i class="fa fa-credit-card p-2" aria-hidden="true"></i>Funds</h1>
                ...
                <div className="col-4">
                    <h1 className="fs-5 mb-3"><i class="fa fa-circle-o-notch p-2" aria-hidden="true"></i>Console</h1>
                ...
                <div className="col-4">
                    <h1 className="fs-5 mb-3"><i class="fa fa-circle-thin p-2" aria-hidden="true"></i>Coin</h1>
